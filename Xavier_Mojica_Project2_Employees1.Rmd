...
PredictionSalaryDF = data.frame(c(CleanEmployeeDataSalary1$ID), c(CleanEmployeeDataSalary1$PredictedSalary))

write.csv(PredictionSalaryDF, "Case2PredictionsMojicaSalary.csv", row.names = TRUE)
...
write.csv(PredictionsAttritionDF, "Case2PredictionsMojicaAttrition.csv", row.names = TRUE)
